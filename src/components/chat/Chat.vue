              ...
              <div class="chat-container">
                ...
                <div class="conversation">
                  <div class="conversation-info">
                    <div v-show="onlineUsers">online users: {{onlineUsers}}</div>
                    <div v-show="userTyping.nickName">{{userTyping.nickName}} is typing...</div>
                  </div>
                  ...
                  <form class="conversation-compose">
                    ...
                    <input v-model="newMsg.txt" @input="typing" class="input-msg" name="input" placeholder="Type a message" autocomplete="off" autofocus></input>
                    <div class="photo">
...
<script>
import msgService from '../../services/chat/msg.service';
import '../../css/chat.css';
...
export default {
  ...
  created() {
    ...
    this.onlineUsers = msgService.onlineUsers;
    this.userTyping = msgService.userTyping;
  },
  methods: {
    createEmptyMsg() {
    ...
    typing(){
      // msgService.typingDebouncer(this.nickName);
